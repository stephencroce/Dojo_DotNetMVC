...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxml="urn:schemas-microsoft-com:xslt" xmlns:cei="urn:schemas-ceinetwork-com">
	...
	<xsl:template match="/">
		<HTML>
          ...
          TABLE TR TD.borderleftrightbottom
          {           
            border-left: #000000 1px solid; 
			...
			<td colspan="4" class="borderleftrightbottom">
				<Table width="100%" border="0" bordercolor="red" cellpadding="0" cellspacing="0">					
					...
					<tr>			
						...
						<td class="borderleftbottom"><b>CAR QUALIFIER:</b></td>
						<td class="borderbottom">
						...
						<td class="borderbottom">
							<xsl:choose>
								...
								<xsl:otherwise>
									...
									<xsl:text> (</xsl:text>
									<xsl:value-of select="cei:replaceEmployeeString(../EDC/DRelationship)"/>
									<xsl:text>)</xsl:text>
								</xsl:otherwise>
							</xsl:choose>																												
						</td>
						...
						<td>
							<xsl:choose>
								<xsl:when test="../EDC/ClaimContactId=0">
									...
									<xsl:text> </xsl:text>
									<xsl:value-of select="../EDC/ELastName"/>
									<xsl:text> (Car Qualifier)</xsl:text>									
								</xsl:when>
								<xsl:otherwise>
									...
									<xsl:text> (</xsl:text>
									<xsl:value-of select="cei:replaceEmployeeString(../EDC/CRelationship)"/>
									<xsl:text>)</xsl:text>
								</xsl:otherwise>
							</xsl:choose>																				
						</td>
		...
		<tr>
			<td colspan="4" class="borderleftrightbottom">
				<table width="100%" cellspacing="0" cellpadding="0">
					<Tr>
						<td width="45%"><b><u>VIOLATIONS/CITATIONS ISSUED</u></b></td>
		...
		<tr>
			<td colspan="4" class="borderleftrightbottom">
				<table width="100%" border="0" bordercolor="blue" cellpadding="0" cellspacing="0">
					<tr>
						<td width="25%"><b><u>CAR QUALIFIER</u></b></td>
			...
			<td colspan="4" class="borderleftrightbottom">
				<table width="100%" border="0" bordercolor="orange" cellpadding="0" cellspacing="0">
					<tr>
						...
						<Td width="15%"><xsl:value-of select="cei:replaceEmployeeString(../EDC/DRelationship)"/></Td>
					</tr>
					<tr>
  ...
  <xsl:template match="TPP">
	...
	<msxml:script language="VB" implements-prefix="cei">
		...
		Function replaceEmployeeString(SearchText As String)
			
			If SearchText.ToUpper = "EMPLOYEE" Then
				Return "Car Qualifier"
			Else
				Return SearchText
			End If
